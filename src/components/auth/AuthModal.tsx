    ...
    <div className="px-4 pb-4 md:px-0 md:pb-0">
      ...
      <div className="relative my-4">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-white px-2 text-slate-400 font-normal">Hoặc tiếp tục với</span>
        </div>
      </div>

      <Button 
        variant="outline" 
        className="w-full h-11 rounded-full bg-white text-slate-700 border-slate-300 hover:bg-slate-50 font-medium shadow-sm flex items-center justify-center gap-3 mt-4"
