...
export default function EventTitleHeader({
  ...
  return (
    <div className="px-4 py-3 sm:px-6 border-b border-slate-100 bg-white shrink-0">
      <div className="flex items-start justify-between gap-3">
        {/* CỤM TRÁI: Tiêu đề + Đổi tên + Số lượng thành viên */}
        ...
        {/* CỤM PHẢI: Nút Xóa sự kiện (Chỉ Creator) */}
        {isCreator && (
